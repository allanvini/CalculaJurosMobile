...
import { calculaAplicacaoRecorrente } from '../calcs/investimento';

export function CalcularAplicacao(){
    ...
    function calcularJuro(){
        const resultados = calculaAplicacaoRecorrente(
            values.valor,
            values.taxaAoMes,
            values.periodoMeses
        )
    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                <Text variant="bodyMedium">Esta sessão serve para você calcular o capital resultante aplicando uma quantia regularmente a uma taxa fixa em um periodo de tempo.</Text>
                <TextInput
                    style={styles.input}
                    placeholder='0.00'
