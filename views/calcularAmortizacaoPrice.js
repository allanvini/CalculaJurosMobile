...
import { calculaAmortizacaoPRICE } from '../calcs/amortizacao';
...
export function CalcularAmortizacaoPrice(){
    ...
    function calcularAmortizacao(){
        const resultados = calculaAmortizacaoPRICE(
            values.saldoDevedor,
        ...
        <ScrollView>
            <View style={styles.container}>
                <Text variant="bodyMedium">
                    Esta sessão serve para você calcular a amortização na modalidade PRICE, onde o valor da parcela é sempre fixo
                </Text>
                <TextInput
                    style={styles.input}
                    placeholder='0.00'
